...
2. After adding in the code to monitor dropped frames, I can see that I'm dropping 60 frames during the experiment, or 3 per trial. In this case, I'll switch back to the clock method.
